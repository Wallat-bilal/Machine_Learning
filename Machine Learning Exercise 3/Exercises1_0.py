...
#     (2) Optional: redo with PCA(2) and compare
# =========================
print("\n=== Three-class experiment: digits {5,6,8} ===")
mask_tr = np.isin(ytr, list(THREE_CLASSES))
mask_te = np.isin(yte, list(THREE_CLASSES))

Xtr_568 = Xtr_std[mask_tr]
ytr_568 = ytr[mask_tr]
Xte_568 = Xte_std[mask_te]
yte_568 = yte[mask_te]

# --- LDA as supervised reducer to 2D ---
...
# --- PCA(2) comparator (optional but requested) ---
